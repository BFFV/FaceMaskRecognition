...
% op.m = 50;                     % 50 escogidas
% op.b.name = 'fisher';          % SFS with Fisher
% op.show = 0;
% s = Bfs_sfs(caract_train_2,d1,op);       % index of selected features
% 
% caract_train_2 = caract_train_2(:,s);    % selected features
% %Datos de testing
% caract_test_2 = caract_test_2(:,s);    % selected features
% %Datos de validacion
% caract_valid_2 = caract_valid_2(:,s);    % selected features
% 
% 
